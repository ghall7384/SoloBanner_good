...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("European", "36px 'Vladimir Script'", "#4670A3");
...
p.nominalBounds = new cjs.Rectangle(-78.5,-23.8,157,47.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.text = new cjs.Text("Adventure", "36px 'Vladimir Script'", "#4670A2");
	this.text.textAlign = "center";
	this.text.lineHeight = 46;
...
p.nominalBounds = new cjs.Rectangle(-78.8,-23.8,157.7,47.7);
...
if (reversed == null) { reversed = false; }
	...
	// Skin
	this.text = new cjs.Text("Click Here", "24px 'Arial'", "#234A9A");
	this.text.textAlign = "center";
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(244.3,-20.85);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(34).to({_off:false},0).to({x:307.8,y:31.4},11).wait(15));

	// European
	this.instance_2 = new lib.Tween4("synched",0);
	this.instance_2.setTransform(99.05,-21.35);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({x:162.55,y:31.4},11).wait(20));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/BG.jpg?1619577130680", id:"BG"},
		{src:"images/solo_banner_atlas_1.png?1619577126339", id:"solo_banner_atlas_1"}
	],
	preloads: []
};
